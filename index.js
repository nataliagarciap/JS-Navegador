...
let transacciones = localStorage.getItem('transacciones') !== null ? localStorageTransactions : [];


// Funcion Ppal
function AñadirTransaccion(e) {
    e.preventDefault();
...
function añadirALista(transaccion) {
    ...
    <button class="delete-boton" onclick="borrarTransaccion(${transaccion.id})">❌</button>`;
